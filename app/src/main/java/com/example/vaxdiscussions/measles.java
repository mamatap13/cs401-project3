...
/*
The small pox class file is where the user is able to enter the information about measles vaccine
            ...
            public void onClick(View v) {
                ...
                mfireStore.collection("userscollection").document(mAuth.getCurrentUser().getUid()).update(Vaccine_info).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Intent intent = new Intent(measles.this, Vaccine_info.class);
