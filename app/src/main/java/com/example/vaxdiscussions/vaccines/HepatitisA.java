...
/**
 * The HepatitisA class file is where the user is able to enter the information about Hepatitis A vaccine
            ...
            public void onClick(View v) {
                ...
                mfireStore.collection("userscollection").document(mAuth.getCurrentUser().getUid()).update(Vaccine_info).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Intent intent = new Intent(HepatitisA.this, com.example.vaxdiscussions.activities.Vaccine_info.class);
